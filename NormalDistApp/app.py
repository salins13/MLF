...
def main():
    ...
    new_sample_size = st.number_input("Add a Custom Sample Size:", min_value=1, step=1)
    if new_sample_size not in sample_sizes and new_sample_size > 0:
        sample_sizes.append(new_sample_size)
    
    num_samples = st.number_input("Number of Samples:", min_value=10, max_value=200, value=100, step=1)
